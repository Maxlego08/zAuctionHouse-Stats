...
import fr.maxlego08.stats.zcore.utils.commands.Arguments;
import org.bukkit.command.CommandSender;
import org.bukkit.entity.Player;

import fr.maxlego08.stats.StatsPlugin;
import fr.maxlego08.stats.save.Config;
import fr.maxlego08.stats.zcore.utils.commands.CollectionBiConsumer;
import fr.maxlego08.stats.zcore.utils.commands.CommandType;
import fr.maxlego08.stats.zcore.utils.commands.Tab;

public abstract class VCommand extends Arguments {

	protected final StatsPlugin plugin;
	 ...
	 * @param plugin
	 */
	public VCommand(StatsPlugin plugin) {
		super();
		this.plugin = plugin;
	}
	 ...
	 * @return
	 */
	public CommandType prePerform(StatsPlugin plugin, CommandSender commandSender, String[] args) {
	 ...
	 */
	protected abstract CommandType perform(StatsPlugin plugin);
	 ...
	 * @return
	 */
	public List<String> toTab(StatsPlugin plugin, CommandSender sender, String[] args) {
