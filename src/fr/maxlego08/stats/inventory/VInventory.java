...
import fr.maxlego08.stats.zcore.utils.builder.ItemBuilder;
...
public abstract class VInventory extends ZUtils implements Cloneable {
	...
	protected InventoryResult preOpenInventory(StatsPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(StatsPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, StatsPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, StatsPlugin plugin, Player player) {
	}
